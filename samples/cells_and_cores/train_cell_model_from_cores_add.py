...
config.USE_BORDER_WEIGHTS = False
config.USE_CORE_FEATURES = True
config.CORE_FEATURE_MERGE_OP = "add"
config.LOSS_WEIGHTS = {
        "rpn_class_loss": 1.,
        "rpn_bbox_loss": 2.,
        "mrcnn_class_loss": 1.,
...
model = modellib.MaskRCNN(mode="training", model_dir=MODEL_DIR+"/cells_with_cores_add", config=config)

core_model_weights="/data/logs/cores/cores20180710T1525/mask_rcnn_cores_0350.h5"
model.load_core_weights(core_model_weights)
